...
exports.LEGACY_SEED_IDS = void 0;
exports.purgeSqlFile = purgeSqlFile;
exports.purgeLegacySeedRows = purgeLegacySeedRows;
exports.queueCloudSeedDeletes = queueCloudSeedDeletes;
const path_1 = __importDefault(require("path"));
const fs_1 = __importDefault(require("fs"));
const replicator_1 = require("./sync/replicator");
exports.LEGACY_SEED_IDS = {
...
function purgeSqlFile() {
    return path_1.default.resolve(__dirname, 'migrations', '007_purge_legacy_seed_data.sql');
}
/**
 ...
 */
function queueCloudSeedDeletes() {
    for (const [table, ids] of Object.entries(exports.LEGACY_SEED_IDS)) {
        for (const id of ids) {
            (0, replicator_1.queueSync)(table, id, 'delete', null);
        }
    }
}
